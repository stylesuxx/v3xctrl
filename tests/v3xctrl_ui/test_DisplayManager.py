...
from src.v3xctrl_ui.DisplayManager import DisplayManager
...
class TestDisplayManager(unittest.TestCase):
    ...
    @patch("src.v3xctrl_ui.DisplayManager.pygame.display.list_modes")
    @patch("src.v3xctrl_ui.DisplayManager.pygame.display.set_mode")
    @patch("src.v3xctrl_ui.DisplayManager.pygame.display.set_caption")
    def test_initialization_windowed(self, mock_caption, mock_set_mode, mock_list_modes):
        ...
        display_manager = DisplayManager(self.model, self.base_size, self.title)
