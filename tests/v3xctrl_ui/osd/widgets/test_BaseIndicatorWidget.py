...
class TestBaseIndicatorWidget(unittest.TestCase):
    ...
    def test_initialization_default_parameters(self):
        widget = ConcreteIndicatorWidget(position=(10, 20), size=(100, 50))
    ...
    def test_valid_range_modes(self):
        widget_symmetric = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), range_mode="symmetric")
        self.assertEqual(widget_symmetric.range_mode, "symmetric")

        widget_positive = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), range_mode="positive")
        self.assertEqual(widget_positive.range_mode, "positive")

    def test_invalid_range_mode_raises_error(self):
        with self.assertRaises(ValueError) as context:
            ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), range_mode="invalid_mode")
    ...
    def test_color_function_assignment(self):
        ...
        widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), color_fn=red_color)
    ...
    def test_draw_background(self):
        with patch("v3xctrl_ui.osd.widgets.BaseIndicatorWidget.Surface") as mock_surface_class:
            ...
            widget = ConcreteIndicatorWidget(position=(25, 35), size=(150, 75), bg_alpha=180)
    ...
    def test_draw_background_different_alpha(self):
        with patch("v3xctrl_ui.osd.widgets.BaseIndicatorWidget.Surface") as mock_surface_class:
            ...
            widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), bg_alpha=100)
    ...
    def test_abstract_draw_method(self):
        with self.assertRaises(TypeError):
            BaseIndicatorWidget(position=(0, 0), size=(100, 50))

    def test_concrete_implementation_can_instantiate(self):
        widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50))
    ...
    def test_size_tuple_unpacking(self):
        widget = ConcreteIndicatorWidget(position=(10, 20), size=(300, 200))

        self.assertEqual(widget.width, 300)
        self.assertEqual(widget.height, 200)

    def test_position_tuple_storage(self):
        widget = ConcreteIndicatorWidget(position=(15, 25), size=(100, 50))
    ...
    def test_zero_size_handling(self):
        widget = ConcreteIndicatorWidget(position=(0, 0), size=(0, 0))

        self.assertEqual(widget.width, 0)
        self.assertEqual(widget.height, 0)

    def test_negative_size_handling(self):
        widget = ConcreteIndicatorWidget(position=(0, 0), size=(-10, -5))
    ...
    def test_zero_alpha_background(self):
        with patch("v3xctrl_ui.osd.widgets.BaseIndicatorWidget.Surface") as mock_surface_class:
            ...
            widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), bg_alpha=0)
    ...
    def test_maximum_alpha_background(self):
        with patch("v3xctrl_ui.osd.widgets.BaseIndicatorWidget.Surface") as mock_surface_class:
            ...
            widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), bg_alpha=255)
    ...
    def test_negative_padding(self):
        widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), padding=-5)
    ...
    def test_color_function_with_different_return_types(self):
        ...
        widget = ConcreteIndicatorWidget(position=(0, 0), size=(100, 50), color_fn=tuple_color_fn)
    ...
    def test_all_parameters_edge_cases(self):
        ...
        widget = ConcreteIndicatorWidget(
            position=(0, 0), size=(1, 1), range_mode="positive", color_fn=edge_color_fn, bg_alpha=1, padding=0
        )
