...
@patch("src.v3xctrl_ui.GamepadManager.pygame.joystick.init")
class TestGamepadManager(unittest.TestCase):
    ...
    @patch("src.v3xctrl_ui.GamepadManager.pygame.joystick.get_count", return_value=2)
    @patch("src.v3xctrl_ui.GamepadManager.pygame.joystick.Joystick")
    @patch("src.v3xctrl_ui.GamepadManager.pygame.time.wait")
    ...
    @patch("src.v3xctrl_ui.GamepadManager.pygame.joystick.get_count", return_value=1)
    @patch("src.v3xctrl_ui.GamepadManager.pygame.joystick.Joystick")
    @patch("src.v3xctrl_ui.GamepadManager.pygame.time.wait")
    ...
    @patch("src.v3xctrl_ui.GamepadManager.pygame.joystick.get_count", return_value=0)
    @patch("src.v3xctrl_ui.GamepadManager.pygame.time.wait")
