...
class TestWidgetFactory(unittest.TestCase):
    ...
    def test_create_steering_widgets_returns_dict(self):
        widgets = WidgetFactory.create_steering_widgets()
    ...
    def test_create_battery_widgets_returns_dict(self):
        widgets = WidgetFactory.create_battery_widgets()
    ...
    def test_create_signal_widgets_returns_dict(self):
        widgets = WidgetFactory.create_signal_widgets()
    ...
    def test_create_debug_widgets_returns_dict(self):
        widgets = WidgetFactory.create_debug_widgets(100, 50)
    ...
    def test_create_debug_widgets_creates_fps_widgets(self):
        fps_width = 120
        fps_height = 60
        widgets = WidgetFactory.create_debug_widgets(fps_width, fps_height)
    ...
    def test_all_widgets_initialized_at_origin(self):
        ...
        steering_widgets = WidgetFactory.create_steering_widgets()
        battery_widgets = WidgetFactory.create_battery_widgets()
        signal_widgets = WidgetFactory.create_signal_widgets()
        debug_widgets = WidgetFactory.create_debug_widgets(100, 50)
    ...
    def test_factory_methods_are_static(self):
        # Verify all factory methods are static and can be called without instance
        self.assertTrue(callable(WidgetFactory.create_steering_widgets))
        self.assertTrue(callable(WidgetFactory.create_battery_widgets))
        self.assertTrue(callable(WidgetFactory.create_signal_widgets))
        self.assertTrue(callable(WidgetFactory.create_debug_widgets))

    def test_create_steering_widgets_is_idempotent(self):
        # Calling multiple times should create independent widget sets
        widgets1 = WidgetFactory.create_steering_widgets()
        widgets2 = WidgetFactory.create_steering_widgets()
    ...
    def test_create_battery_widgets_is_idempotent(self):
        widgets1 = WidgetFactory.create_battery_widgets()
        widgets2 = WidgetFactory.create_battery_widgets()
    ...
    def test_create_signal_widgets_is_idempotent(self):
        widgets1 = WidgetFactory.create_signal_widgets()
        widgets2 = WidgetFactory.create_signal_widgets()
    ...
    def test_create_debug_widgets_is_idempotent(self):
        widgets1 = WidgetFactory.create_debug_widgets(100, 50)
        widgets2 = WidgetFactory.create_debug_widgets(100, 50)
