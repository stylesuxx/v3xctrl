...
class TestGamepadCalibrationWidget(unittest.TestCase):
    def setUp(self):
        ...
        with patch('v3xctrl_ui.menu.calibration.GamepadCalibrationWidget.Select') as mock_select, \
            ...
            self.mock_button_mapping = MagicMock()
            ...
            mock_button_mapping.return_value = self.mock_button_mapping
            ...
            self.mock_button_mapping.get_size.return_value = (300, 35)
    ...
    def test_handle_event_normal_ui_interaction(self):
        ...
        for button_widget in self.widget.button_mapping_widgets.values():
            button_widget.handle_event.return_value = False
