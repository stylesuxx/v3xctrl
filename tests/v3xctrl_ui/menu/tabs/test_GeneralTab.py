...
class TestGeneralTab(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        assert self.tab.video == self.settings.video
    ...
    def test_on_render_ratio_change_with_invalid_value(self):
        ...
        original_value = self.tab.video.render_ratio
        self.tab._on_render_ratio_change("not_a_number")

        # Value should not change
        assert self.tab.video.render_ratio == original_value
    ...
    def test_refresh_from_settings(self):
        ...
        self.settings.set("video", {"fullscreen": True, "render_ratio": 50})
        self.settings.set("show_connection_info", False)
