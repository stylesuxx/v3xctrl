...
class TestFrequenciesTab(unittest.TestCase):
    ...
    def setUp(self):
        self.settings = build_settings(timing={"main_loop_fps": 60, "control_update_hz": 30, "latency_check_hz": 10})
        self.tab = FrequenciesTab(self.settings, width=640, height=480, padding=10, y_offset=0)
