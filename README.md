...
- [Terminology](/stylesuxx/v3xctrl/wiki/Terminology) - read this to understand the terminology of the project
- [Recommended Hardware](/stylesuxx/v3xctrl/wiki/Hardware) - Which hardware you are going to need
- [Streamer Setup](/stylesuxx/v3xctrl/wiki/Streamer) - How to set up your hardware (the streamer)
- [Motivation](/stylesuxx/v3xctrl/wiki/Motivation) - If you want to understand why things are implemented as they are, this document should help you
- [Troubleshooting](/stylesuxx/v3xctrl/wiki/Troubleshooting) - read this before opening issues, your problem might have already been solved
- [Latency Breakdown](/stylesuxx/v3xctrl/wiki/Latency) - how much latency is there and where does it come from?
...
> Check [Recommended Hardware](/stylesuxx/v3xctrl/wiki/Hardware) for a list of compatible modems and cameras.
...
Make sure to follow the [Streamer setup guide](/stylesuxx/v3xctrl/wiki/Streamer#installation-recommended).
...
> Should this not be the case, follow the [Troubleshooting Guide](/stylesuxx/v3xctrl/wiki/Troubleshooting#video-stream).
...
If you have any questions or problems, feel free to open an issue. Please make sure to check the [Troubleshooting Guide](/stylesuxx/v3xctrl/wiki/Troubleshooting) first, your problem might have already been solved.

## Development

Check the following documentation if you are interested in contributing to the project:

- [Development](/stylesuxx/v3xctrl/wiki/Development) - how to setup your development environment
- [Release](/stylesuxx/v3xctrl/wiki/Release) - how to release a new version of the project
