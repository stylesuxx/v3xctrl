...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="GStreamer video streaming pipeline")
    ...
    if args.transport == Transport.TCP:
        ...
        if args.relay_session_id:
            handshake = PeerAnnouncement(r="streamer", i=args.relay_session_id, p="video").to_bytes()
